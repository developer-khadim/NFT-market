    ...
    <div className="text-white py-6 sm:py-8 md:py-32 px-3 sm:px-4 md:px-6 lg:px-8 min-h-screen">
      <div className='pb-6 sm:pb-8 md:pb-12 flex flex-col md:flex-row md:justify-between md:items-end'>
        <div className='mb-4 md:mb-0'>
          <p className="capitalize text-white/60 text-xs sm:text-sm md:text-base">most appreciated NFTs on sale for the day</p>
          <h1 className='capitalize text-xl sm:text-2xl md:text-3xl lg:text-5xl font-medium py-2 sm:py-3'>Live Auction NFTs</h1>
        </div>
